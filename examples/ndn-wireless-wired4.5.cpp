 ...
 */
  ...
  int main (int argc, char *argv[])
  {
    ...
    // ndn::AppDelayTracer::InstallAll("ndn-wireless-wired-app-delays-trace4.5.txt");
    ndn::AppDelayTracer::Install(consumers[0],"ndn-wireless-wired-app-delays-trace4.5.txt");
