 ...
 */
  ...
  int main (int argc, char *argv[])
  {
    ...
    topologyReader.SetFileName("src/ndnSIM/examples/topologies/topo-x.txt");
    topologyReader.Read();
    ...
    Simulator::Schedule(Seconds(0.0), CheckPIT, producer);
    Simulator::Schedule(Seconds(5.0), CheckPIT, producer);
    Simulator::Schedule(Seconds(10.0), CheckPIT, producer);
    Simulator::Schedule(Seconds(15.0), CheckPIT, producer);
    Simulator::Schedule(Seconds(20.0), CheckPIT, producer);
