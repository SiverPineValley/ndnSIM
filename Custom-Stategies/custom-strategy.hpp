...
class CustomStrategyBase : public Strategy
{
public:
  void
...
protected:
  CustomStrategyBase(Forwarder& forwarder);
};
 ...
 */
class CustomStrategy : public CustomStrategyBase
{
public:
  explicit
  CustomStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
