 ...
 */
  ...
  int main (int argc, char *argv[])
  {
    ...
    // ndn::AppDelayTracer::InstallAll("ndn-wireless-wired-app-delays-trace3.4.txt");
    ndn::AppDelayTracer::Install(consumers[0],"ndn-wireless-wired-app-delays-trace3.4.txt");
