...
DcaTxop::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::DcaTxop")
	...
	// .AddAttribute ("Collision", "Packet Collision at Mac",
	// 			   UintegerValue(0),
	// 		       MakeUintegerAccessor (&DcaTxop::SetCollision,&DcaTxop::GetCollision),
	// 			   MakeUintegerChecker<uint32_t>())
  ;
  return tid;
}
...
// void
// DcaTxop::SetCollision (uint32_t col)
// {
//   this->m_collision = col;
// }

// int
// DcaTxop::GetCollision (void) const
// {
